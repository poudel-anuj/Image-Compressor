...
namespace ImageCompressor
{
    ...
    public class ImageUpload
    {
        ...
        private readonly string UploadPath = "~/Content/CompressedImage";
        private readonly string originalImageUploadPath = "~/Content/OriginalImage";
        ...
        public ImageResult RenameUploadFile(HttpPostedFileBase file, Int32 counter = 0)
        {
            ...
            if (System.IO.File.Exists
                (HttpContext.Current.Request.MapPath(originalImageUploadPath + finalFileName)))
            {
